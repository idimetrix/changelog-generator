...
[![Build & Test](https://github.com/idimetrix/changelog-generator/actions/workflows/changelog.yml/badge.svg)](https://github.com/idimetrix/changelog-generator/actions/workflows/changelog.yml)
[![Repo Dependents](https://badgen.net/github/dependents-repo/idimetrix/changelog-generator)](https://github.com/idimetrix/changelog-generator/network/dependents)
...
<a target="__blank" href="https://github.com/idimetrix/changelog-generator/releases">
...
- name: Generate changelog
  ...
  with:
    ...
    filter-author: (idimetrix|Dmitrii Selikhov|dependabot|renovate\\[bot\\]|dependabot\\[bot\\]|Renovate Bot)
...
- name: Create Release
  ...
  with:
    ...
    body: |
      ...
      Document Website: https://raw.githack.com/idimetrix/changelog-generator/${{ steps.changelog.outputs.gh-pages-short-hash }}/index.html
```

Define the log display template ([#111](https://github.com/idimetrix/changelog-generator/issues/111#issuecomment-1594085749)).
...
- name: Generate Changelog(custom-emoji test)
  ...
  with:
    token: ${{ secrets.GITHUB_TOKEN }}
    filter-author: (Dmitrii Selikhov|Renovate Bot)
    filter: '[R|r]elease[d]\s+[v|V]\d(\.\d+){0,2}'
...
- `filter-author` Regular expression filtering author. Example: [`filter-author: (idimetrix|Dmitrii Selikhov|dependabot\[bot\]|Renovate Bot)`](https://github.com/idimetrix/changelog-generator/blob/f48f63cdb5f3c5d8b6499c6d96e3450ee7bdb9f5/.github/workflows/changelog.yml#L17)
- `filter` Regular expression filtering changelog. Example: [`filter: '[R|r]elease[d]\s+[v|V]\d(\.\d+){0,2}'`](https://github.com/idimetrix/changelog-generator/blob/b372394a4e7265d4041c479b4d1f515a9c21ec37/.github/workflows/release.yml#L21)
...
- `template` Define the log display template ([#111](https://github.com/idimetrix/changelog-generator/issues/111#issuecomment-1594085749)).
...
repository uses this action and GitHub releases for an [example](https://github.com/idimetrix/changelog-generator/blob/600f36ff605c63a74a264ab324247f0c392bf7a2/.github/workflows/changelog.yml#L12-L18).
...
- [More Examples...](https://github.com/idimetrix/changelog-generator/network/dependents)

## Contributors

As always, thanks to our amazing contributors!

<a href="https://github.com/idimetrix/changelog-generator/graphs/contributors">
  <img src="https://idimetrix.github.io/changelog-generator/CONTRIBUTORS.svg" />
</a>

Made with [action-contributors](https://github.com/idimetrix/github-action-contributors).
